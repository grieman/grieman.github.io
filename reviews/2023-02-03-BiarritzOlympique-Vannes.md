...
The first set of predictions treats a club as the smallest object, as the club develops its members, organizes a gameplan, and deploys its players as needed for each match. This club model has a prediction of 0.663, which translates to predicting Biarritz Olympique to win by 5.9.

Each club has a rating and a rating deviation (simiar to a Glicko system), and expected performances can be generated. This allows for simulated matches and spreads like the ones below.
## Projected Performances


![Projected Performances](plots/performances_2023-02-03-BiarritzOlympique-Vannes.png)
## Projected Spreads


![Projected Spreads](plots/spreads_2023-02-03-BiarritzOlympique-Vannes.png)
## Projected Results


![Projected Results](plots/resultbar_2023-02-03-BiarritzOlympique-Vannes.png)
...
![In Match Scores](plots/recap_scores_2023-02-03-BiarritzOlympique-Vannes.png)
## Win Probability over Time


![In Match Predictions](plots/recap_prob_2023-02-03-BiarritzOlympique-Vannes.png)
