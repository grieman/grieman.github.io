...
The first set of predictions treats a club as the smallest object, as the club develops its members, organizes a gameplan, and deploys its players as needed for each match. This club model has a prediction of 0.647, which translates to predicting Carcassonne to win by 5.3.

Each club has a rating and a rating deviation (simiar to a Glicko system), and expected performances can be generated. This allows for simulated matches and spreads like the ones below.
## Projected Performances


![Projected Performances](plots/performances_2023-01-27-Carcassonne-Rouen.png)
## Projected Spreads


![Projected Spreads](plots/spreads_2023-01-27-Carcassonne-Rouen.png)
## Projected Results


![Projected Results](plots/resultbar_2023-01-27-Carcassonne-Rouen.png)
...
![In Match Scores](plots/recap_scores_2023-01-27-Carcassonne-Rouen.png)
## Win Probability over Time


![In Match Predictions](plots/recap_prob_2023-01-27-Carcassonne-Rouen.png)
...
|---------------:|:------------------------------------------------------------------------|-----------:|------------------:|---------:|------------------:|-----------:|:-------------------------------------------------------------------------|---------------:|
|             32 | [Antoine Fournier](..//playerfiles//AntoineFournier_cleaned.md)         |      84.04 |                10 |        1 |                 7 |      76.35 | [Jules Martinez](..//playerfiles//JulesMartinez_cleaned.md)              |             45 |
